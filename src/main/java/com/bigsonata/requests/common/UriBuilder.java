...
/**
 * A utility class customized from apache http-client URIBuilder to build URIs.
 *
...
public final class UriBuilder {
  ...
  public static UriBuilder newInstance(final boolean encode) {
    return new UriBuilder(encode);
  }
  ...
  public static UriBuilder newInstance(final String string) {
  ...
  public static UriBuilder newInstance(final String string, boolean encode) {
    return new UriBuilder(string, encode);
  }
  ...
  public static UriBuilder newInstance(final URI uri) {
        ...
        for (final String parameter : parametersArray) {
          ...
          if (firstIndex != -1) {
            ...
            if (parameterCombo.length >= 1) {
              ...
              final String val =
                  parameterCombo.length == 2
                      ? URLDecoder.decode(parameterCombo[1], utf8.name())
                      : "";
  ...
  private String encodeUserInfo(final String userInfo) {
    return this.encode ? urlEncode(userInfo) : userInfo;
  }

  private String encodePath(final String path) {
    return this.encode ? urlEncode(path) : path;
  }

  private String encodeUrlForm(final List<BasicNameValuePair> params) {
    final StringBuilder result = new StringBuilder();
    for (final BasicNameValuePair parameter : params) {
      final String encodedName = this.encode ? urlEncode(parameter.getName()) : parameter.getName();
      final String encodedValue =
          this.encode ? urlEncode(parameter.getValue()) : parameter.getValue();
  ...
  private String encodeUric(final String fragment) {
    return this.encode ? urlEncode(fragment) : fragment;
  }
  ...
  /**
   * Sets URI user info as a combination of username and password. These values are expected to be
  ...
  /**
   * Sets URI query parameters. The parameter name / values are expected to be unescaped and may
   * contain non ASCII characters.
   *
   * <p>Please note query parameters and custom query component are mutually exclusive. This method
   * will remove custom query if present.
   */
  private UriBuilder setParameters(final List<BasicNameValuePair> nvps) {
  ...
  private UriBuilder setParameters(final String queryParameters) {
    this.queryParams = new ArrayList<BasicNameValuePair>();
  ...
  /**
   * Adds URI query parameters. The parameter name / values are expected to be unescaped and may
   * contain non ASCII characters.
   *
   * <p>Please note query parameters and custom query component are mutually exclusive. This method
   * will remove custom query if present.
   */
  private UriBuilder addParameters(final List<BasicNameValuePair> nvps) {
   ...
   * will remove custom query if present.
   */
  private UriBuilder setParameters(final BasicNameValuePair... nvps) {
  ...
  /**
   * Adds parameter to URI query. The parameter name and value are expected to be unescaped and may
   * contain non ASCII characters.
   *
   * <p>Please note query parameters and custom query component are mutually exclusive. This method
   * will remove custom query if present.
   */
  public UriBuilder addParameterUnescaped(final String param, final String value) {
    if (this.queryParams == null) {
      this.queryParams = new ArrayList<BasicNameValuePair>();
    }
  ...
  public UriBuilder addParameter(final String param, final String value) {
    return addParameterUnescaped(urlEncode(param), urlEncode(value));
  }

  /**
   * Sets parameter of URI query overriding existing value if set. The parameter name and value are
   * expected to be unescaped and may contain non ASCII characters.
   *
   * <p>Please note query parameters and custom query component are mutually exclusive. This method
   * will remove custom query if present.
   */
  public UriBuilder setParameterUnescaped(final String param, final String value) {
    ...
    this.queryParams.add(new BasicNameValuePair(param, encodeValue));
    this.encodedQuery = null;
    this.encodedSchemeSpecificPart = null;
    this.query = null;
    return this;
  ...
  public UriBuilder setParameter(final String param, final String value) {
    return setParameterUnescaped(urlEncode(param), urlEncode(value));
  }
  ...
  public boolean equals(final Object o) {
    ...
    if (encodedSchemeSpecificPart != null
        ? !encodedSchemeSpecificPart.equals(that.encodedSchemeSpecificPart)
        : that.encodedSchemeSpecificPart != null) return false;
    if (encodedAuthority != null
        ? !encodedAuthority.equals(that.encodedAuthority)
        : that.encodedAuthority != null) return false;
    if (userInfo != null ? !userInfo.equals(that.userInfo) : that.userInfo != null) return false;
    if (encodedUserInfo != null
        ? !encodedUserInfo.equals(that.encodedUserInfo)
        : that.encodedUserInfo != null) return false;
    ...
    return !(encodedFragment != null
        ? !encodedFragment.equals(that.encodedFragment)
        : that.encodedFragment != null);
  }
  ...
  public int hashCode() {
    ...
    result =
        31 * result
            + (encodedSchemeSpecificPart != null ? encodedSchemeSpecificPart.hashCode() : 0);
